        ...
        <div className="UserProfile">
            ...
            <div>
                ...
                <div style={{display:"flex",justifyContent:"space-between",width:"90%"}}>
                    ...
                    <h6><b>{userProfile.user.following.length}</b>followings</h6>
                </div>
                {showfollow?
                
                <button className="btun-follow" style={{width:"250px", marginTop:"15px", marginBottom:"15px", height:"28px"}}
                    onClick={()=>followUser()}
                    >Follow</button>
                :
                <button className="btun-follow" style={{width:"250px", marginTop:"15px", marginBottom:"15px", height:"28px"}}
          ...
          <div className="gallery">
             {
                 userProfile.posts.map(item=>{
                     return(
                      <img key={item._id} className="item" src={item.photo} alt={item.body} />
                     )
                   })
             }
          </div>
